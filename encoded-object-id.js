...
const ENCODED_OBJECT_ID_HEX_REGEX = /^[0-9a-fA-F_-]{16}$/;
...
class EncodedObjectId {
    ...
    static encode(objectId) {
        ...
        return CryptoURL.encodeBase64(objectId.toString());
    }
    ...
    static decode(encodedObjectId) {
        ...
        const str = CryptoURL.decodeBase64(encodedObjectId);
    ...
    static isValid(value) {
        return typeof value === 'string'
            && value.length === 16
            && ENCODED_OBJECT_ID_HEX_REGEX.test(value) === true;
    }
